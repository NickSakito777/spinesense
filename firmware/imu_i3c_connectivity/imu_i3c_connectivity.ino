...
static constexpr uint8_t IMU_COUNT = 3;
...
static ImuSlot imus[IMU_COUNT] = {
  ...
  {"IMU2", "D7/PA8", GPIOA, GPIO_PIN_8, 0x34},
};
...
void setup()
{
  ...
  delay(300);
  VCP.println();
  VCP.println("=== ISM6HG256X 3-IMU I3C connectivity test ===");
  VCP.println("Expected wiring:");
  VCP.println("SCL=D15/PB13, SDA=D14/PB14, TA0: IMU0=D2, IMU1=D4, IMU2=D7");
